...
TRAVIS_TCAD_AUTHORIZED_CITIES = ("DEL VALLE", "MANOR")
TRAVIS_TCAD_PROOF_PAGE_SIZE = 2
TRAVIS_TCAD_PROOF_MAX_RECORDS = 2
TRAVIS_TCAD_COHORT_PAGE_SIZE = 250
TRAVIS_TCAD_COHORT_MAX_RECORDS = 1000
...
TRAVIS_TCAD_SOURCE = SourceDescriptor(
    ...
    parser_version="travis-tcad-parcel-geometry-v2",
